...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Fri Dec 03 11:24:31 CET 2021
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports incrIN]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports incrOUT]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports incrIN]
