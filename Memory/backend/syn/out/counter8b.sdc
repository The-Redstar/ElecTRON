...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Fri Dec 03 11:42:22 CET 2021
...
current_design counter8b

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports {countOUT[7]}]
set_load -pin_load 1.0 [get_ports {countOUT[6]}]
set_load -pin_load 1.0 [get_ports {countOUT[5]}]
set_load -pin_load 1.0 [get_ports {countOUT[4]}]
set_load -pin_load 1.0 [get_ports {countOUT[3]}]
set_load -pin_load 1.0 [get_ports {countOUT[2]}]
set_load -pin_load 1.0 [get_ports {countOUT[1]}]
set_load -pin_load 1.0 [get_ports {countOUT[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {countOUT[0]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports clk]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports rst]
